...
FROM 'C:\Users\ikhsaanmh\Desktop\bootcamp\Mini Project\SQL\Dataset\customers_dataset.csv'
DELIMITER ','
CSV HEADER;
...
FROM 'C:\Users\ikhsaanmh\Desktop\bootcamp\Mini Project\SQL\Dataset\geolocation_dataset.csv'
DELIMITER ','
CSV HEADER;
...
FROM 'C:\Users\ikhsaanmh\Desktop\bootcamp\Mini Project\SQL\Dataset\order_items_dataset.csv'
DELIMITER ','
CSV HEADER;
...
FROM 'C:\Users\ikhsaanmh\Desktop\bootcamp\Mini Project\SQL\Dataset\order_payments_dataset.csv'
DELIMITER ','
CSV HEADER;
...
FROM 'C:\Users\ikhsaanmh\Desktop\bootcamp\Mini Project\SQL\Dataset\order_reviews_dataset.csv'
DELIMITER ','
CSV HEADER;
...
-- Import dataset
COPY orders_dataset
FROM 'C:\Users\ikhsaanmh\Desktop\bootcamp\Mini Project\SQL\Dataset\orders_dataset.csv'
DELIMITER ','
CSV HEADER;
...
FROM 'C:\Users\ikhsaanmh\Desktop\bootcamp\Mini Project\SQL\Dataset\product_dataset.csv'
DELIMITER ','
CSV HEADER;
...
FROM 'C:\Users\ikhsaanmh\Desktop\bootcamp\Mini Project\SQL\Dataset\sellers_dataset.csv'
DELIMITER ','
CSV HEADER;
